...
overall_metrics = {
    ...
    "weighted_auc": float(roc_auc_score(y_cv, y_probabilities, multi_class = "ovr", average = "weighted")),
...
per_class = classification_report(y_cv, y_pred, labels = CLASSES, output_dict = True) # Calculates per class precision, recall, F1, support
